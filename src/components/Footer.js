...
import { APP_STORE_IMG, PLAY_STORE_IMG } from "../utils/constant";

const Footer = () => {
  return (
    <>
      <div className=" hidden md:flex min-h-[104px] bg-gray-200 mt-20 items-center justify-center ">
        ...
        <div className="flex justify-center my-auto mx-2 h-16 gap-5">
          <img src={PLAY_STORE_IMG} alt="googleplay" />
          <img src={APP_STORE_IMG} alt="appstore" />
        </div>
      </div>
      <footer className="mt-6 md:mt-0 bg-[#02060C] text-white py-12 px-8 md:px-56">
        <div className="container grid grid-cols-1 text-center  md:grid-cols-4 gap-4 mx-auto">
          <div className="md:col-start-1 col-end-auto row-start-1 row-end-5">
            ...
            <h4 className="text-gray-300 my-4">© 2023 made By Manvendra</h4>
          </div>
